...
def get_conntrack_count():
    try:
        # Use sudo with -n to prevent password prompts; make sure sudoers is configured for this command
        ...
        # conntrack -C outputs just the number
        return int(count)
    except subprocess.CalledProcessError as e:
        # If sudo requires password or conntrack not found, return -1 or handle as needed
        return -1
    except Exception:
        return -1
